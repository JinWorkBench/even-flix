...
const NewOnNetflix: React.FC<NewOnNetflixProps> = ({
  newOnNetflix,
  movieGenres,
  hovered,
  modalPosition,
            ...
            <div className="mb-4">
              <img
                src={`https://image.tmdb.org/t/p/w300${
                  newOnNetflix.find((item) => item.id === hovered)
                    ?.backdrop_path
                }`}
                alt="Modal"
            ...
            <div className="pt-1 pb-3 px-3">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-400 mt-2">
                <span className="border border-gray-500 px-2 py-1 rounded">
                  {newOnNetflix.find((item) => item.id === hovered)?.adult
                    ? "19+"
                    : "15+"}
                </span>
                <span className="border border-gray-500 px-2 py-1 rounded">
